 ...
 */
final class Version20260409125512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE request (id INT AUTO_INCREMENT NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, tel VARCHAR(10) NOT NULL, date DATETIME NOT NULL, status VARCHAR(255) NOT NULL, code_mail VARCHAR(18) NOT NULL, uuid VARCHAR(255) NOT NULL, service_id INT NOT NULL, house_id INT DEFAULT NULL, INDEX IDX_3B978F9FED5CA9E6 (service_id), INDEX IDX_3B978F9F6BB74515 (house_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
