 ...
 */
final class Version20260410105930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, doc LONGTEXT NOT NULL, request_id INT DEFAULT NULL, home_id INT NOT NULL, INDEX IDX_D8698A76427EB8A5 (request_id), INDEX IDX_D8698A7628CDC89C (home_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE request (id INT AUTO_INCREMENT NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, tel VARCHAR(10) NOT NULL, date DATETIME NOT NULL, status VARCHAR(255) NOT NULL, code_mail VARCHAR(18) DEFAULT NULL, uuid VARCHAR(255) DEFAULT NULL, service_id INT NOT NULL, house_id INT DEFAULT NULL, INDEX IDX_3B978F9FED5CA9E6 (service_id), INDEX IDX_3B978F9F6BB74515 (house_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
